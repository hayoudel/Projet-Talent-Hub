...
app.post('/inscription', (req, res) => {
    ...
    const INSERT_USER_QUERY = `INSERT INTO utilisateurs (prenom, nom, email, mot_de_passe) VALUES (?, ?, ?, ?)`;
...
app.post('/connexion', (req, res) => {
    ...
    const FIND_USER_QUERY = 'SELECT * FROM User WHERE email = ? AND mot_de_passe = ?';
